...
def uniformCostSearch(problem):
    ...
    while ( not Fringe.isEmpty() ):
        ...
        if curr_state not in Closed:
            Closed.append( curr_state )
            for next_state, action, cost in problem.getSuccessors(curr_state):
                Fringe.push( (next_state, path + [action]), problem.getCostOfActions(path)+cost )
    ...
    while ( not Fringe.isEmpty() ):
        ...
        if curr_state not in Closed:
            ...
            for next_state, action, cost in problem.getSuccessors(curr_state):
                ...
                #     Fringe.update( (next_state, path + [action]), problem.getCostOfActions(path) + cost + heuristic(next_state, problem) )
                Fringe.push( (next_state, path + [action]), problem.getCostOfActions(path)+cost+heuristic(next_state, problem) )
